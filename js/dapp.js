...
const CONTRACT_ADDRESS = '0x73D4879Cefd35BE82D9ee0c19A042b6a99c951A4'
const DEFAULT_REFERRAL = '0xe2637603aea9435A0E3eA4E1b470578d73EE51ef'
...
function showRefLink (totalInvested, currentAccount) {
    ...
    if (totalInvested.eq(0)) {
        ...
        const link = window.location.origin + '/poluxury/?ref=' + currentAccount
        refLink.text(link)
